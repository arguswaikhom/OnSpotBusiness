...
import com.crown.onspotbusiness.databinding.LiOldOrderBinding;
...
public class OldOrderVH extends RecyclerView.ViewHolder {
    ...
    private void onClickedNavDetails(View view) {
        // todo: implement item details page
    ...
    public void bind(OSOldOrder order) {
        ...
        binding.customerNameTv.setText(Html.fromHtml("<b>" + order.getCustomer().getDisplayName() + "</b>"));
